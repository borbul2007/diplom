...
echo "export TF_VAR_network_k8s_id=$(terraform output yandex_vpc_network_k8s_id)" >> resources/.profile
echo "export TF_VAR_subnet_k8s-0_id=$(terraform output yandex_vpc_subnet_k8s-0_id)" >> resources/.profile
echo "export TF_VAR_subnet_k8s-1_id=$(terraform output yandex_vpc_subnet_k8s-1_id)" >> resources/.profile
echo "export TF_VAR_subnet_k8s-2_id=$(terraform output yandex_vpc_subnet_k8s-2_id)" >> resources/.profile
